        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('logo.update', $logo->id)}}" method="post" class="needs-validation dropzone" enctype="multipart/form-data" novalidate id="myAwesomeDropzone" data-plugin="dropzone" data-previews-container="#file-previews" data-upload-preview-template="#uploadPreviewTemplate">
                        @csrf
                        @method('PUT')
                        ...
                        <div id="mediaPreview" class="mb-3">
                            @if ($logo->image)
                            @if (in_array(pathinfo($logo->image, PATHINFO_EXTENSION), ['jpeg', 'png', 'jpg', 'gif']))
                            <img src="{{ asset('storage/' . $logo->image) }}" class="preview-image">
                            @else
                            <video src="{{ asset('storage/' . $logo->image) }}" class="preview-image" controls></video>
                            @endif

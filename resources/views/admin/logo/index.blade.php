            ...
            <div class="row">
                ...
                <div class="col-lg-6 text-end">
                    <a href="{{ route('logo.create') }}" class="btn btn-primary">
                        <i class="mdi mdi-plus-circle"></i> Create logo
                    </a>
                </div>
            </div>
        </div>
                        ...
                        <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img src="/storage/{{$l->image}}" style="width: 100px;" alt=""></td>
                                    <td>
                                        <div class="mx-1 d-inline-block">
                                            <a href="{{ route('logo.edit', $l->id) }}"><i class="mdi mdi-book-edit-outline fs-3"></i></a>
                                        </div>
                                        <div class="mx-1 d-inline-block">
                                            <form action="{{ route('logo.destroy', $l->id) }}" method="POST" onsubmit="return confirm('Ochirishga ruxsat berasizmi')">
                                                @csrf
                                                @method('DELETE')

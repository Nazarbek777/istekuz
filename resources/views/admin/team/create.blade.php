        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('team.store')}}" method="post" class="needs-validation dropzone" enctype="multipart/form-data" novalidate id="myAwesomeDropzone" data-plugin="dropzone" data-previews-container="#file-previews" data-upload-preview-template="#uploadPreviewTemplate">
                        @csrf

                        <div class="mb-3">
                            <label for="validationCustom01" class="form-label">To'liq ism</label>
                            <input type="text" class="form-control" id="validationCustom01" name="full_name" placeholder="Ism kiriting" required>
                        </div>
                        <div class="mb-3">
                            <label for="validationCustom01" class="form-label">Kasbi</label>
                            <input type="text" class="form-control" id="validationCustom01" name="job" placeholder="kasbni kiriting" required>
                        </div>
                        <div class="mb-3">
                            <label for="validationCustom01" class="form-label">Qobilyati</label>
                            <input type="text" class="form-control" id="validationCustom01" name="skill" placeholder="Qobilyatni kiriting" required>
                        </div>
                        <div class="mb-3">
                            <label for="validationCustom01" class="form-label">Tajribasi</label>
                            <input type="text" class="form-control" id="validationCustom01" name="experience" placeholder="Necha yillik tajribaga egasiz" required>
                        </div>
                        <div class="mb-3">
                            <label for="validationCustom01" class="form-label">Facebook manzili</label>
                            <input type="text" class="form-control" id="validationCustom01" name="facebook_link" placeholder="link" >
                        </div>
                        <div class="mb-3">
                            <label for="validationCustom01" class="form-label">Instagram manzili</label>
                            <input type="text" class="form-control" id="validationCustom01" name="instagram_link" placeholder="link" >
                        </div>
                        <div class="mb-3">
                            <label for="validationCustom01" class="form-label">Telegram manzili</label>
                            <input type="text" class="form-control" id="validationCustom01" name="telegram_link" placeholder="link" >
                        </div>
                        <div class="mb-3">
                            <label for="validationCustom01" class="form-label">YouTube manzili</label>
                            <input type="text" class="form-control" id="validationCustom01" name="youTube_link" placeholder="link" >
                        </div>
                        <h2 class="mt-5"> batafsil</h2>
                        <div class="mb-3">
                            <label for="description_uz" class="form-label">batafsil O'zbek tilida</label>
                            <textarea name="description_uz" class="form-control" id="description_uz" placeholder="Yangiliklar haqida batafsil Uz" rows="4" ></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="description_ru" class="form-label">batafsil Rus tilida</label>
                            <textarea name="description_ru" class="form-control" id="description_ru" placeholder="Yangiliklar haqida batafsil Ru" rows="4" ></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="description_en" class="form-label">batafsil Ingliz tilida</label>
                            <textarea name="description_en" class="form-control" id="description_en" placeholder="Yangiliklar haqida batafsil En" rows="4" ></textarea>
                        </div>
                        <style>
                            .custom-file-input {
                                display: none;

        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('product.store')}}" method="post" class="needs-validation dropzone" enctype="multipart/form-data" novalidate id="myAwesomeDropzone" data-plugin="dropzone" data-previews-container="#file-previews" data-upload-preview-template="#uploadPreviewTemplate">
                        @csrf
                        <h2>Kategoriyalar</h2>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="validationCustom01" name="name_uz" placeholder="Nomi Uz" required>
                        </div>
                        <div class="mb-3">
                            <label for="validationCustom01" class="form-label">Mavzu Rus tilida</label>
                            <input type="text" class="form-control" id="validationCustom01" name="name_ru" placeholder="Nomi Ru" required>
                        </div>
                        <div class="mb-3">
                            <label for="validationCustom01" class="form-label">Mavzu Ingliz tilida</label>
                            <input type="text" class="form-control" id="validationCustom01" name="name_en" placeholder="Nomi En" required>
                        </div>
                        ...
                        <div class="mt-3">
                            ...
                            <a href="{{ route('product.index')}}" class="btn btn-danger" type="submit">O'chirish</a>
                        </div>
                    </form>
